...
"""
Gross measure of the threshold: regular steps method.
Fine measure of the threshold: dichotomy method.
"""
...
def threshold_measurement_regular_dichotomy(do_experiment, V0 = 0.*mV):
    ...
    if do_experiment:
        ...
        shutil.copy('threshold_adaptation_regular_dichotomy.py', path)
