...
"""
Gross measure of the threshold: regular method with large steps.
Fine measure of the threshold: regular method with small steps.
"""
...
def threshold_measurement(do_experiment, V0 = 0.*mV):
    ...
    if do_experiment:
        ...
        shutil.copy('threshold_adaptation_regular_regular.py', path)
